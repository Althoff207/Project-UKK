        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16 items-center">
                ...
                <div class="flex items-center gap-6">
                    <a href="{{ route('user.dashboard') }}" class="text-sm font-medium text-gray-700 hover:text-indigo-600">Katalog</a>
                    <a href="{{ route('user.history') }}" class="text-sm font-medium text-gray-500 hover:text-indigo-600">Riwayat</a>
